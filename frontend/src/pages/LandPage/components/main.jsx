        ...
        <div className="w-full h-[650px] items-center justify-center flex relative flex-col overflow-x-hidden">
            ...
            <div className="w-[95%] h-full pt-4 text-white flex flex-col">
                ...
                <div className="flex flex-col">
                    ...
                    <button onClick={() => Navigate('/auth')} className="px-1 py-1.5 w-1/6 h-fit font-poppins font-extrabold text-white bg-primary-100 rounded-md mt-5 flex items-center justify-center space-x-5 duration-500 text-[17px] group">
                        <h1>CONTINUAR</h1>
