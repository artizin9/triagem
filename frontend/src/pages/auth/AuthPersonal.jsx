...
export function AuthPersonal(){
    ...
    return (
        ...
        <div className="h-[80%] w-[40%] max-md:w-[80%] max-md:h-[90%] max-md:max-h-[570px] max-md:max-w-[300px] bg-[#252424] rounded-2xl flex items-center space-y-5 flex-col shadow-[#0908088a] relative z-10 max-md:space-y-3 max-lg:h-[60%] max-lg:w-[80%] max-lg:max-h-[600px] max-lg:max-w-[550px] max-lg:space-y-10 max-2xl:max-h-[550px] max-2xl:max-w-[530px] max-xl:h-[90%] max-xl:max-h-[550px] max-xl:w-[70%] max-xl:max-w-[550px]"> 
            <header className="flex flex-col mt-2 w-full items-center relative "> 
                    ...
                    <h3 className=" text-white text-[16px] font-aleo font-normal -translate-y-3 max-md:text-[14px] text-center max-md:mt-1">A jornada de cada aluno começa com o seu conhecimento </h3>
            ...
            <form method='post' onSubmit={NãoEnviarForm} className="w-[85%] flex justify-center items-center p-2 flex-col relative max-md:w-[90%] max-md:p-1 ">
                    ...
                    { Form.map((item, index) => (
                        <div key={index} className="flex flex-col justify-center w-full relative"> 
                            ...
                            <input 
                                ...
                                name = {item.getnameAxios} // Se for utulizar axios, aqui o name para ajudar logo
                ...
                <div className='w-full'>
                        <h2 className='text-[#FFF4A3] text-[14px] mt-0.5 cursor-pointer duration-200 md:hover:text-[#fcea60] active:text-[#fcea60] w-fit font-aleo font-ligth'> 
