...
export function Aluno({ aluno, setAluno, OpenCreate, OpenUpdate, OpenDelete, OpenSeeTraining, setForm }) {
    ...
    const filteredAlunos = aluno.filter((aluno) => {
        ...
        switch (filterType) {
            case "name":
                return aluno.name.toLowerCase().includes(query);
            case "email":
                return aluno.email.toLowerCase().includes(query);
            case "phone":
                return aluno.phone.toLowerCase().includes(query);
            case "state":
                return aluno.state.toLowerCase().includes(query);
            case "city":
                return aluno.city.toLowerCase().includes(query);
            default:
                return true
        }
    })
