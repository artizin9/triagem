...
import { getTraining } from "../../../utils/api/api"
...
export function Treino({ treino, setTreino, setFormTreino, OpenCreateTraining, OpenSeeTraining, OpenDeleteTraining, OpenUpdateTraining, OpenSendTraining}) {
    ...
    useEffect(() => {
        const response = async () => await getTraining(setTreino)
        response()
    }, [])
