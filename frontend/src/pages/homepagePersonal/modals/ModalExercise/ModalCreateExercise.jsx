...
import { createExercise } from "../../../../utils/api/api"
...
export function CreateExercise({ Treino, setTreino, Close, Open, formExercise, setFormExercise, CleanFormExercise, formTreino, ReadExercise }) {
    ...
    const { photo, name, numberExec, numberRep, execByRep, interval, description, file} = formExercise
    const { id } = formTreino
    ...
    async function CreateExercise() {
        ...
        await createExercise(id, formDataExercise)
    }
