...
export function UpdateAluno({ aluno, setAluno, Close, Open, form, setForm }) {
    ...
    const { id, name, photo, password, email, phone, file, state, city } = form
            ...
            <div
                ...
                <div className="h-full w-full flex items-center justify-center relative">
                    <h1 className={`font-albert duration-500 font-medium text-[16px] text-white absolute top-2 ${messageRight ? 'opacity-100' : 'opacity-0'}`}>
                        O aluno foi atualizado com sucesso!</h1>
                    <button
                        onClick={UpdateAluno}
